...
def train(model,
    ...
    for epoch in range(n_epochs):
        ...
        for ii, (data, target) in enumerate(train_loader):
            ...
            loss.backward()
            #print("Total gradient is:")
            #print(sum([p.grad.abs().sum() for p in model.parameters() if p.requires_grad==True]), end='\n')
            # tensor(1184.2426)
            ...
            #print("Change is weight is:")
            #print((w1 - w0).abs().sum(), end='\n')
            ...
            #b = model.preBlock[0]._parameters['bias'].detach()
            #print(b-b_previous)
            #b_previous = b
